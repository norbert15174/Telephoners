...
public class ProjectsService {
    ...
    public boolean enrolPersonInTheProject(long projectId, long personalId) {
        ...
        if (project.isPresent() && personalData.isPresent())
            return enrolPersonInTheProject(project.get(), personalData.get());
        return false;
    }
    ...
    public boolean deleteProject(long id, long projectId) {
        ...
        if (project.isPresent()) {
            if (project.get().getLeader().getId() == id) deleteProjectByAdmin(projectId);
        }
        ;
        return false;
    }
